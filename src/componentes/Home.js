                            ...
                            <div class="flex flex-wrap w-1/2">
                                <div class="w-1/2 p-1 md:p-2">
                                    <img alt="gallery" class="block object-cover object-center w-full h-full rounded-lg"
                                        src="https://res.cloudinary.com/dqsb2do9p/image/upload/v1663218410/cld-sample-3.jpg" />
                                </div>
                                <div class="w-1/2 p-1 md:p-2">
                                    <img alt="gallery" class="block object-cover object-center w-full h-full rounded-lg"
                                        src="https://res.cloudinary.com/dqsb2do9p/image/upload/v1663218411/cld-sample-5.jpg" />
                                </div>
                                <div class="w-full p-1 md:p-2">
                                    <img alt="gallery" class="block object-cover object-center w-full h-full rounded-lg"
                                        src="https://res.cloudinary.com/dqsb2do9p/image/upload/v1663218410/cld-sample-4.jpg" />
                                </div>
                            </div>
                            <div class="flex flex-wrap w-1/2">
                                <div class="w-full p-1 md:p-2">
                                    <img alt="gallery" class="block object-cover object-center w-full h-full rounded-lg"
                                        src="https://res.cloudinary.com/dqsb2do9p/image/upload/v1663218408/cld-sample.jpg" />
                                </div>
                                <div class="w-1/2 p-1 md:p-2">
                                    <img alt="gallery" class="block object-cover object-center w-full h-full rounded-lg"
                                        src="https://res.cloudinary.com/dqsb2do9p/image/upload/v1670816546/Mangoo6-transformed_z9bfeg.jpg" />
                                </div>
                                <div class="w-1/2 p-1 md:p-2">
                                    <img alt="gallery" class="block object-cover object-center w-full h-full rounded-lg"
                                        src="https://res.cloudinary.com/dqsb2do9p/image/upload/v1663218392/samples/ecommerce/car-interior-design.jpg" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section>
                    <div class="container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row">
                        <div class="flex justify-center xl:w-1/2">
                            <img class="h-80 w-80 sm:w-[28rem] sm:h-[28rem] flex-shrink-0 object-cover rounded-full" src="https://res.cloudinary.com/dqsb2do9p/image/upload/v1669833104/Mangoo1_h2xtnv.jpg" alt="" />
                        </div>

                        <div class="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0 my-10 bg-white shadow rounded-lg p-10 ">
                            <h2 class="text-3xl font-bold tracking-tight text-gray-800 xl:text-4xl dark:text-black">
                                Descarga nuestra aplicación gratuita
                            </h2>

                            <p class="block max-w-2xl mt-4 text-xl text-gray-500 dark:text-black">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iusto recusandae tenetur iste quaerat voluptatibus quibusdam nam repudiandae </p>
                            ...
                            <div class="mt-6 sm:-mx-2">
                                <div class="inline-flex w-full overflow-hidden rounded-lg shadow sm:w-auto sm:mx-2">
                                    <a href="#" class="inline-flex items-center justify-center w-full px-5 py-3 text-base font-medium text-white bg-gradient-to-r from-gray-700 to-gray-900 hover:from-gray-600 hover:to-gray-600 sm:w-auto">
                                        <svg class="w-6 h-6 mx-2 fill-current" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" space="preserve">
                                            <g>
                                                <g>
